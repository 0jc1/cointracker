...
class WalletForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'address': forms.TextInput(attrs={'class': 'f-field', 'placeholder': 'Enter wallet address'}),
        }
    ...
    def clean_wallet_type(self):
        ...
        if wallet_type not in allowed_coins:
            raise forms.ValidationError('Only BTC, ETH, SOL, LTC, or BNB wallets are allowed.')
        return wallet_type
