            ...
            try:
                ...
                for user in users:
                    try:
                        ...
                        create_portfolio_object(user, total_balance.quantize(Decimal('0.01')), minutes=30)
                                            
                    except Exception as e:
                        self.stdout.write(self.style.ERROR(f'Error updating portfolio for user {user.username}: {str(e)}'))
                        continue
